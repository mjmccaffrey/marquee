...
from .devices_misc import (
    ButtonAction, ControlName, ControlVirtuallyChanged
)
...
class Button:
    ...
    def button_physically_held(self) -> None:
        ...
        self.action_in_control_set(self.name, ButtonAction.HELD)

    def button_physically_pressed(self) -> None:
        """Callback for physical button press."""
        self.action_in_control_set(self.name, ButtonAction.PRESSED)

    def button_physically_released(self) -> None:
        """Callback for physical button release."""
        self.action_in_control_set(self.name, ButtonAction.RELEASED)
    ...
    def button_virtually_pressed(self, signal_number, stack_frame) -> None:
        ...
        raise ControlVirtuallyChanged(control=self.name, action=ButtonAction.PRESSED)
